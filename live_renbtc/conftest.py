...
@pytest.fixture
def renBTC_whale(accounts):
    yield accounts.at("0x93054188d876f558f4a66b2ef1d97d16edf0895b", force=True)


@pytest.fixture
def amount(accounts, renBTC, gov_live):
    amount = 0.5 * 10 ** renBTC.decimals()
    # In order to get some funds for the token you are about to use,
    # it impersonate an exchange address to use it's funds.

    reserve = accounts.at("0x93054188d876f558f4a66b2ef1d97d16edf0895b", force=True)
    renBTC.transfer(gov_live, amount, {"from": reserve})
    yield amount
...
def strategy_live(Strategy, live_vault, accounts, web3):
    strategy = Strategy.at("0xC8B55e29a05d7f31790cA8F9D0BD8aA7B4B15b85")
    yield strategy


@pytest.fixture
def live_vault(pm):
    yield Contract("0x3408324Dbb537886CADc180f6FfCf674eE215F67")

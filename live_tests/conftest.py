...
@pytest.fixture
def token(accounts):
    yield accounts.at("0x6B175474E89094C44Da98b954EedeAC495271d0F", force=True)
...
@pytest.fixture
def strategy_live(Strategy, live_dai_vault):
    strategy = Strategy.at("0x74BE9EB35b07F6FC8d767B9F980c1D7854Bf0364")
    yield strategy

@pytest.fixture
def live_dai_vault(pm):
    Vault = pm(config["dependencies"][0]).Vault
    yield Vault.at("0xB98Df7163E61bf053564bde010985f67279BBCEC")

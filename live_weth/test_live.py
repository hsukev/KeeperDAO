...
def test_migration_with_reward(weth, live_vault, strategy_live, amount, Strategy, gov_live, strategist, gov, pool,
                               rook_distributor, rook,
                               rewards, keeper, chain, accounts, web3):
    ...
    strategyBreakdown(new_strategy, weth, live_vault)
